...
import { Components } from 'weiss-sandbox';
...
@Component({
  selector: 'uswds-extended-header',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  // eslint-disable-next-line @angular-eslint/no-inputs-metadata-property
  inputs: [],
...
export declare interface UswdsExtendedHeader extends Components.UswdsExtendedHeader {}


@ProxyCmp({
  inputs: ['enableSearch', 'headerTitle', 'navItems']
})
@Component({
  selector: 'uswds-header',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  // eslint-disable-next-line @angular-eslint/no-inputs-metadata-property
  inputs: ['enableSearch', 'headerTitle', 'navItems'],
...
export declare interface UswdsSideNav extends Components.UswdsSideNav {}


@ProxyCmp({
})
@Component({
  selector: 'uswds-side-nav-item',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  // eslint-disable-next-line @angular-eslint/no-inputs-metadata-property
  inputs: [],
...
export declare interface UswdsSideNavItem extends Components.UswdsSideNavItem {}


@ProxyCmp({
})
@Component({
  selector: 'uswds-side-nav-sub-list',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  // eslint-disable-next-line @angular-eslint/no-inputs-metadata-property
  inputs: [],
